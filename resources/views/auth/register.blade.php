        ...
        <div class="register-form mt-5 px-3">
            ...
            <form action="{{ route('register') }}" method="post"> @csrf
                ...
                <div class="form-group text-left mb-4">
                    ...
                    <input class="input-psswd form-control" id="registerPassword" type="password" name="password"
                        placeholder="Password">
                </div>
                <div class="form-group text-left mb-4">
                    <label for="password"><i class="lni lni-lock"></i></label>
                    <input class="input-psswd form-control" id="registerPassword" type="password" name="password_confirmation"
