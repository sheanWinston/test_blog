...
<!-- Mirrored from demo.designing-world.com/newsten-v1.0.0/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Apr 2020 18:02:01 GMT -->
...
<body>
    ...
    <div class="sidenav-wrapper" id="sidenavWrapper">
        ...
        <ul class="sidenav-nav">
            <li><a href="live.html"><i class="lni lni-play"></i>Live<span
                        class="red-circle ml-2 flashing-effect"></span></a></li>
            <li><a href="profile.html"><i class="lni lni-user"></i>My Profile</a></li>
            <li><a href="pages.html"><i class="lni lni-files"></i>All Pages<span
                        class="ml-2 badge badge-danger">HOT</span></a></li>
            <li><a href="catagory.html"><i class="lni lni-grid-alt"></i>All Category <span
                        class="ml-2 badge badge-warning">14+</span></a></li>
            <li><a href="settings.html"><i class="lni lni-cog"></i>Settings</a></li>

            @auth
                <li><a onclick="logout()" href="#"><i class="lni lni-power-switch"></i>Log out</a></li>
            @endauth

            @guest
                <li><a  href="{{ route('login') }}"><i class="lni lni-power-switch"></i>Log in</a></li>
            @endguest
